...
void WebSocketClient::onTextMessageReceived(QString message)
{
    ...
    if (type == "login_success") {
        ...
        emit userTyping(obj["chatId"].toString(), obj["username"].toString());
    } else if (type == "presence_update") {
        emit userPresenceChanged(obj["userId"].toString(), obj["online"].toBool());
    } else if (type == "message_deleted") {
        emit messageDeleted(obj["chatId"].toString(), obj["messageId"].toString());
    } else if (type == "error") {
